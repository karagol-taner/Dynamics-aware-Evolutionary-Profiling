...
We provide additionally a Python package for high-throughput local analysis. 
[![PyPI version](https://badge.fury.io/py/adept-evo.svg)](https://badge.fury.io/py/adept-evo)
...
* For researchers needing to process sensitive data locally or integrate ADEPT into bioinformatics pipelines, we offer the standalone adept-evo python library:
...
CLI Usage
You can run the full analysis and mapping pipeline directly from your terminal:
```
adept --name MyProtein --rmsf data/rmsf.csv --data data/cons.csv --pdb structure
```

* For running on Colab: [Link](./ADEPT.ipynb)
